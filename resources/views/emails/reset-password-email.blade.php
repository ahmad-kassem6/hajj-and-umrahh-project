                    ...
                    <tr>
                        <td class="sm-py-32 sm-px-24"
                            ...
                            <p style="font-size: 20px; font-weight: 600; color: #555; margin: 0;">
                                Hey, <span style="color: #87674f; font-weight: 700;">{{$name}}</span>!
                            </p>
                            <p style="font-size: 24px; font-weight: 600; color: #263238; margin-top: 16px; margin-bottom: 16px;">
                                Password Reset Request 🔒
                            </p>
                            <p style="color: #555; margin-bottom: 24px;">
                                We received a request to reset the password for your account. If you did not request a
                                password reset, please ignore this email. Otherwise, please use the code below to reset
                                your password.
                            </p>
                            ...
                            <p style="margin-top: 32px; color: #555;">
                                If you did not request this change, please secure your account by updating your
                                password.
                            </p>
                            <p style="color: #555; margin: 0;">
